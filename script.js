...
$(document).ready(()=>{
    ...
    while(counter<seriesData.length){
        $(".series-box").append('<div class="col-2" id="series-pagination-item">'+
    ...
    let itemSeries = document.querySelectorAll('#series-pagination-item');
    let itemCount = $('#paginated-list').children().length;
    let currentPage;
    let itemEachPage = 6;
